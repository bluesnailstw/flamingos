...
from salt.exceptions import PepperException
...
from urllib.request import HTTPHandler, HTTPSHandler, Request, urlopen, install_opener, build_opener
...
class Pepper(object):
    ...
    def __init__(self, api_url=settings.SALT_MASTER_API_HOST, debug_http=False, ignore_ssl_errors=False):
        '''
    ...
    def login(self, username=settings.SALT_MASTER_API_USER, password=settings.SALT_MASTER_API_PASSWORD, eauth='pam',
              **kwargs):
        '''
