<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="子组数量" align="center">
        <template slot-scope="scope">
          <span class="link-type" @click="detailView(scope.row)">{{ scope.row.children.length }}</span>
        </template>
      </el-table-column>
      <el-table-column label="主机数量" align="center">
        <template slot-scope="scope">
          <span class="link-type" @click="detailView(scope.row)">{{ scope.row.hosts.length }}</span>
        </template>
      </el-table-column>
...
<script>
import { fetchList, createItem, updateItem, delItem } from '@/api/host_groups'
...
export default {
  ...
  created() {
    // console.info(this.is_root)
    // console.info(this.parent)
    // this.listQuery.is_root = this.is_root
    // this.listQuery.parent = this.parent
    this.getList()
  },
  methods: {
    reset() {
