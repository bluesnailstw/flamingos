        ...
        <el-form-item label="组内成员">
          <el-row>
            <el-transfer
              ...
              :data="userOptions"
              v-model="temp.user_set"
              filterable
              style="text-align: left; display: inline-block"
              filter-placeholder="过滤内容"/>
          </el-row>
        </el-form-item>
      </el-form>
...
<script>
import { fetchList, createItem, updateItem, delItem, fetchOption } from '@/api/groups'
  ...
  methods: {
    getOptions() {
      fetchOption().then(response => {
        ...
        this.userOptions = this.listOptions.ext.users
      })
    },
    getList() {
