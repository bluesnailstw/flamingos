...
COPY docker/entrypoint_worker  /opt/run/code/entrypoint_worker
COPY docker/entrypoint_beat  /opt/run/code/entrypoint_beat
COPY docker/entrypoint_worker_web  /opt/run/code/entrypoint_worker_web
RUN chmod +x /opt/run/code/entrypoint
RUN chmod +x /opt/run/code/entrypoint_worker
RUN chmod +x /opt/run/code/entrypoint_beat
RUN chmod +x /opt/run/code/entrypoint_worker_web
